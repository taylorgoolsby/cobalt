...
1. <a id="introduction" href="#introduction">Introduction</a>
  ...
  Welcome to **agencyai.gg** (“**Company**”, “**we**”, “**our**”, “**us**”)! As you have just clicked our Terms of Service, please pause, grab a cup of coffee and carefully read the following pages. It will take you approximately 20 minutes.
  
  These Terms of Service (“**Terms**”, “**Terms of Service**”) govern your use of our web pages located at [agencyai.gg](https://agencyai.gg) (“**Service**”) and operated by Taylor Goolsby.
  
  Our Privacy Policy also governs your use of our Services and explains how we collect, safeguard and disclose information that results from your use of our web pages. Please read it here [agencyai.gg/privacy](https://agencyai.gg/privacy).
...
8. <a id="fee-changes" href="#fee-changes">Fee Changes</a>
  ...
  agencyai.gg, in its sole discretion and at any time, may modify Subscription fees for the Subscriptions. Any Subscription fee change will become effective at the end of the then-current Billing Cycle.
...
10. <a id="content" href="#content">Content</a>
  ...
  agencyai.gg has the right but not the obligation to monitor and edit all Content provided by users.
  
  In addition, Content found on or through these Services are the property of agencyai.gg or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.
...
30. <a id="contact-us" href="#contact-us">Contact Us</a>
  ...
  By email: <Contact/>.
  <br/>
<!--  By visiting this page on our website: [agencyai.gg/contact](https://agencyai.gg/contact).-->
`.trim()
