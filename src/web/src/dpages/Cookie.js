...
1. ## [Introduction](#introduction)
   ...
   At agencyai.gg, we believe in being clear and open about how we collect and use data related to you. This policy provides detailed information about how and when we use cookies. By accessing and using our website and services, you indicate that you understand and agree to this policy.
...
If you wish to change your cookie preferences on agencyai.gg, you can do so by deleting the site's local storage data in your browser. This will prompt the cookie settings banner to reappear, allowing you to modify your settings upon reloading the website. Follow these steps to delete the local storage:

1. **Google Chrome**:
   - Click on the three dots in the top right corner and select 'Settings'.
   - Go to 'Privacy and security' and click on 'Third-party cookies'.
   - Find 'See all site data and permissions' and search for 'agencyai.gg'.
...
2. **Mozilla Firefox**:
   ...
   - Click on 'Manage Data', find 'agencyai.gg', and click 'Remove Selected'.

3. **Safari (Mac)**:
   - Go to 'Safari' in the menu bar and select 'Settings'.
   - Choose the 'Privacy' tab and click on 'Manage Website Data'.
   - Find 'agencyai.gg' in the list and click 'Remove'.
...
4. **Microsoft Edge**:
   ...
   - Search for 'agencyai.gg' and delete the local storage data.
...
After deleting the local storage for agencyai.gg, reload the website. The cookie settings banner will reappear, allowing you to adjust your cookie preferences as desired.

7. ## [Third-Party Cookies in Use on agencyai.gg](#third-party-cookies-in-use-on-agencyaigg)
